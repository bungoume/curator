...
cli.add_command(delete_indices, name="delete_indices")
cli.add_command(delete_snapshots, name="delete_snapshots")
cli.add_command(forcemerge)
cli.add_command(open_indices, name="open_indices")
cli.add_command(replicas)
cli.add_command(snapshot)
cli.add_command(restore)
cli.add_command(rollover)
cli.add_command(shrink)
cli.add_command(show_indices, name="show_indices")
cli.add_command(show_snapshots, name="show_snapshots")
